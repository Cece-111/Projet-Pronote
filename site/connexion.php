...
if(isset($_POST['connexion'])){
    ...
    if(empty($_POST['pseudo'])){ 
        ...
        if(empty($_POST['mdp'])){
            ...
            $mysqli = mysqli_connect("document.ext", "nom d'utilisateur", "mot de passe");
            ...
            if(!$mysqli){
                ...
                $Requete = mysqli_query($mysqli,"SELECT * FROM utilisateur WHERE nom = '".$Pseudo."' AND mdp = '".$MotDePasse."'");
